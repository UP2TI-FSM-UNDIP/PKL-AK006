                ...
                <main className="flex-1 min-w-0 overflow-x-hidden px-3 sm:px-6 lg:px-12 pt-4 sm:pt-8 pb-8">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 sm:mb-6 gap-3">
                        <div className="flex items-center gap-2">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-gray-900 dark:text-gray-100 shrink-0">
                                <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
                                <polyline points="14 2 14 8 20 8" />
                            </svg>
                            <h1 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white">Pratinjau Surat</h1>
                        </div>
                        ...
                        <div className="flex items-center justify-between sm:justify-end gap-3">
                            ...
                            <div className="flex items-center gap-2 sm:gap-3 bg-white dark:bg-gray-800 px-3 sm:px-4 py-2 rounded-lg shadow-sm dark:shadow-gray-900/50 transition-colors">
                                ...
                                <button
                                    ...
                                    className="text-gray-700 dark:text-gray-300 font-medium min-w-[50px] sm:min-w-[60px] text-center hover:bg-gray-100 dark:hover:bg-gray-700 px-2 py-1 rounded transition-colors text-sm"
                                >
                                    {zoom}%
                                </button>
                                <button
                    ...
                    <div
                        ref={containerRef}
                        className="bg-[#E5E5E5] dark:bg-gray-800 rounded-lg p-2 sm:p-4 lg:p-8 overflow-auto transition-colors min-h-[400px] sm:min-h-[600px]"
                    >
